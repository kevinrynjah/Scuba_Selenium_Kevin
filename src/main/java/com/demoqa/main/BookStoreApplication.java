...
import com.demoqa.utilities.CommonFunctions;
...
public class BookStoreApplication {
	...
	public static void deleteParticularBook() throws InterruptedException
	{
		List<WebElement> list = commonMethods.getDriver().findElements(By.xpath("//div[text()='Title']//following::span[contains(@id,'see-book-')]"));
		int size= list.size();
	...
	public static void deleteAllBooks() throws InterruptedException
	{
		commonMethods.ScrollByPixel(0, 1000);
